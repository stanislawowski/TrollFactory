...
parser.add_argument('--gender', dest='gender', type=str, default='male')
...
def generate(dataset, gender):
    properties = load_props()
    country_code = {'polish': 'PL', 'english_us': 'US'}[dataset]
    properties_static = {'language': {'language': dataset, 'country_code': country_code}, 'gender': {'gender': gender}}
...
if __name__ == '__main__':
    ...
    for _ in range(args.amount):
        properties = load_props()
        generated = generate(dataset, gender)
